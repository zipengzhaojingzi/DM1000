...
const char *alu_shr_num_keyword = "alu_shr_num";
const char *alu_shl_num_keyword = "alu_shl_num";
const char *alu_rcr_keyword = "alu_rcr";
const char *alu_rcr_num_keyword = "alu_rcr_num";
const char *alu_rcl_num_keyword = "alu_rcl_num";
...
struct PATH_INSTRUCTION_OPERAND_ENTRY path_operand_table[] =
	{
		...
		,
		{&alu_shl_num_keyword, &a_register_keyword, 0x90d6ff2f} // path alu_shl_num, a   here i want to add the number of shift
		,
		{&alu_shr_num_keyword, &a_register_keyword, 0x90d5ff2f} // path alu_shr_num, a   here i want to add the number of shift
		,
		{&alu_rcr_keyword, &a_register_keyword, 0x90e5ffef} // path alu_rcr, a
		,
		{&alu_rcr_num_keyword, &a_register_keyword, 0x90e5ffef} // path alu_rcr_num, a   here i want to add the number of shift
		,
		{&alu_rcl_keyword, &a_register_keyword, 0x90e6ffef} // path alu_rcl, a
		,
		{&alu_rcl_num_keyword, &a_register_keyword, 0x90e6ffef} // path alu_rcl_num, a   here i want to add the number of shift
		,
